        ...
        <section class="booking-hero">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <img src="img/floating-market.jpg" alt="Chợ nổi Cần Thơ" class="booking-hero-img">
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                <form id="bookingForm" method="POST" action="index.php?controller=booking&action=create">
                                    <div class="row">
